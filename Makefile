...
.PHONY: composition-audit fair-scaling-run fair-scaling-aggregate fair-scaling-summarize cross-cohort-summary paper revision
...
revision: composition-audit fair-scaling-summarize cross-cohort-summary paper
