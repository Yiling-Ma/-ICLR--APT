...
substantially easier than fine subtype prediction. At fixed total-cell budgets,
reallocating cells from 8 to 32 subjects improves subject-balanced macro-F1 in
37 of 38 comparisons across APT, external COMBAT CITE-seq RNA/ADT, and external
OneK1K RNA evaluations; one low-budget XGBoost coarse setting reverses, and
effect magnitude is context-dependent. Strict nested
