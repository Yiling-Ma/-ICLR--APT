...
The final \ourmethod{} configuration does not use class-balanced sampling. We evaluated a class-balanced sampler during development but did not retain it because it underperformed natural sampling after controlling the number of optimization steps. This single-split diagnostic is not used to support any component claim.
...
We omit unmatched detector rankings. Disease-level rejection remains future work requiring prespecified ID/OOD patients, matched supervision, patient-clustered uncertainty, and complete prevalence reporting.
