...
its gains over lineage composition and a cell-count-only control have
...
cross-task error propagation, while limiting disease conclusions to the APT
cohort.
\end{abstract}
...
\paragraph{Strict nested composition bridge.}
...
To characterize assay measurement sensitivity, we asked how many of the 293
aptamers preserve the observed within-cohort disease result. This is not a
clinical deployment or biomarker analysis. Patient-Stable Aptamer Selection
