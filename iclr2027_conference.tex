...
primary matched control. This extension is an external-cohort saturation
...
$32\rightarrow128$ contrasts are likewise unresolved. The external curves are
therefore consistent with a plateau over this tested fixed-total range rather
than a continued subject-breadth gain. Because the intervention remains tied
to these tasks, budgets, features, and LR configuration, it does not locate a
universal saturation point or optimal allocation.
