...
The corresponding budget curve is shown in the main text (Figure~\ref{fig:panel_curve_main}). Here we retain only the additional interpretation and ranking details.
