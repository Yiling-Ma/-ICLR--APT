...
substantially easier than fine subtype prediction. At three fixed total-cell
budgets, reallocating cells from 8 to 32 subjects improves subject-balanced
macro-F1 in all 30 comparisons across APT and external COMBAT CITE-seq RNA and
ADT evaluations, although effect magnitude is context-dependent. Strict nested
