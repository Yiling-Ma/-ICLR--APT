...
reallocations confound subject breadth with label support and class composition:
although 37 of 38 comparisons favor 32 rather than 8 subjects, a class-matched
control reduces this apparent advantage to modest coarse gains in APT and
OneK1K, while fine effects are small and change sign across cohorts. Thus the
unmatched result is an audit target, not evidence for a universal
subject-dominant scaling law.
Strict nested
