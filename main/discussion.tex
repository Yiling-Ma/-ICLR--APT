...
overall deployable gain. The paired-input increment asks a different question:
...
The v2 frozen-score tests address two deployable readout rules, and the
conditional subtype MLP tests one trained alternative, without covering all
possible hierarchical learners. True-lineage masking and shuffling are
...
not yet translate this signal into an overall deployable gain. The repeated
