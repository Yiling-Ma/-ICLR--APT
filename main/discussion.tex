...
or guarantee that predicted-lineage decoding realizes the oracle gain.
The v2 frozen-score tests address two such deployable rules, without covering
all possible trained hierarchical models; an APT-only conditional shuffle
remains a distinct unanswered comparison. True-lineage
