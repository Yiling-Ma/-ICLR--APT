...
The close point estimates establish neither equivalence nor component effects;
training and selection differences are summarized in
Table~\ref{tab:main_training_protocols}. Overlap of individual-model intervals
is not a paired superiority test.
...
Saved-score diagnostics further locate the errors: in this full-budget MLP,
cross-parent and within-parent subtype errors occupy 49.4\% and 17.3\% of
patient-balanced cell mass, respectively. Oracle corrects 63.2\% of cross-parent
errors when correction fractions are first computed within each patient.
The two largest remaining directed confusions are CD8 Tem-1 to CD4 + Tcm-1
and the reverse, ranked first and second in all three seeds. Both subtypes
occur in all 40 patients. These error rates complement, rather than additively
decompose, Macro-F1; complete diagnostics appear in
Appendix~\ref{sec:appendix:mlp_failures}.
