...
As an exploratory appendix stress test, we hold out all patients from one disease group for testing and train on the remaining five groups. This is the only protocol in which the test set contains a disease entirely absent from training, but it is not part of the main benchmark claims.
