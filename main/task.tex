...
We evaluate models under three protocols with different purposes.
...
To evaluate novelty with respect to disease category, we hold out all patients from one disease group for testing and train on the remaining five groups. This is the only protocol in which the test set contains a disease entirely absent from training. LODO is used for both the unseen-disease generalization analysis and the novelty-detection experiments.
