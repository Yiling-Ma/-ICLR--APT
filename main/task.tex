...
We therefore evaluate the lineage-to-subtype hierarchy without imposing a
disease-to-lineage-to-subtype label tree; a secondary composition-recovery
example is confined to the appendix.
...
Disease-group prediction is outside the present result set. With one
...
are not reselected. Historical cell-weighted leaderboards are archived.
...
Disease-classification, feature-panel and inference-budget audits are
retained outside this manuscript; no corresponding disease or assay-efficiency
claim is made here.
