...
test missing-class recovery. Completed real-cohort A--D results appear in
Section~\ref{sec:sequential_completed}; the historical class-matched tables
must not be interpreted as that decomposition.
