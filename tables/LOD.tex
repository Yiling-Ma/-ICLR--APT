...
0.152 and coarse Macro-F1 0.326. A separate Normal-held-out run produces
near-chance fine performance. LODO is reported only as an exploratory
appendix stress test, not as proof that the model already solves
