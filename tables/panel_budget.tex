...
\caption{
Nested patient-level panel selection for disease recognition. In each
outer fold, aptamer ranking and budget selection are performed using
outer-training patients only, and the selected budget is evaluated once on
the untouched outer-test patients. Under the prespecified tolerance margin
$\delta=0.02$, all five folds select the same development budget
...
This result supports a measurement-efficiency interpretation rather than a
claim of unique causal biomarkers.
}
